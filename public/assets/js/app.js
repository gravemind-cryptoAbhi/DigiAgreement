!(function (t) {
	...
	function s(e) {
		1 == t('#light-mode-switch').prop('checked') && 'light-mode-switch' === e
			? (t('#dark-mode-switch').prop('checked', !1),
			  ...
			  t('#app-style').attr('href', '%PUBLIC_URL%/assets/css/app.min.css'),
			...
			? (t('#light-mode-switch').prop('checked', !1),
			  ...
			  t('#bootstrap-style').attr(
					'href',
					'%PUBLIC_URL%/assets/css/bootstrap-dark.min.css',
			  ),
			  t('#app-style').attr(
					'href',
					'%PUBLIC_URL%/assets/css/app-dark.min.css',
			  ),
			...
			: 1 == t('#rtl-mode-switch').prop('checked') &&
			  ...
			  t('#app-style').attr('href', '%PUBLIC_URL%/assets/css/app-rtl.min.css'),
	...
	t('#side-menu').metisMenu(),
		t('#vertical-navmenu-btn').on('click', function (e) {
			e.preventDefault(),
		...
		t('#sidebar-navbar-menu a').each(function () {
